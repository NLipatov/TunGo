...
func TestTransportHandler_RekeyAck_Handled(t *testing.T) {
	for _, kind := range []servicepacket.HeaderType{servicepacket.RekeyAck, servicepacket.RekeyAckV2} {
		...
		t.Run(name, func(t *testing.T) {
			...
			_ = servicepacket.Encode(kind, ackPayload)
...
func TestTransportHandler_EpochExhausted_ReturnsError(t *testing.T) {
	...
	_ = servicepacket.Encode(servicepacket.EpochExhausted, epochPayload)
...
func TestTransportHandler_HandleRekeyAck_ErrorDoesNotBubble(t *testing.T) {
	...
	_ = servicepacket.Encode(servicepacket.RekeyAck, shortAck)
...
func TestTransportHandler_Pong_Consumed(t *testing.T) {
	...
	_ = servicepacket.Encode(servicepacket.Pong, pongPayload)
